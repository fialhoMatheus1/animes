...
<section class="altura">
        <form method="get" action="/editar-anime">
            <div class="pesquisar">
        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    <th class="txt-coluna" scope="col">Código</th>
            ...
            <tbody>
                ...
                <tr>
                    <th class="txt-coluna" scope="row">{{$registrosFinais->id}}</th>
                    ...
                    <td>
                        <a href="{{route('alterar-anime', $registrosFinais->id)}}">
                    ...
                    <td>
                        <form method="Post" action="{{route('apagar-anime', $registrosFinais->id)}}">
                            @method('delete')
                            @csrf
